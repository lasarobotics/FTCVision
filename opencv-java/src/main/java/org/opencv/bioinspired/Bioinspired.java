...
public class Bioinspired {
    ...
    public static Retina createRetina(Size inputSize)
    {
        ...
        Retina retVal = new Retina(createRetina_0(inputSize.width, inputSize.height));
    ...
    public static Retina createRetina(Size inputSize, boolean colorMode, int colorSamplingMethod, boolean useRetinaLogSampling, float reductionFactor, float samplingStrenght)
    {
        ...
        Retina retVal = new Retina(createRetina_1(inputSize.width, inputSize.height, colorMode, colorSamplingMethod, useRetinaLogSampling, reductionFactor, samplingStrenght));
    ...
    public static Retina createRetina(Size inputSize, boolean colorMode)
    {
        ...
        Retina retVal = new Retina(createRetina_2(inputSize.width, inputSize.height, colorMode));
    ...
    // C++:  Ptr_Retina createRetina(Size inputSize)
    private static native long createRetina_0(double inputSize_width, double inputSize_height);

    // C++:  Ptr_Retina createRetina(Size inputSize, bool colorMode, int colorSamplingMethod = RETINA_COLOR_BAYER, bool useRetinaLogSampling = false, float reductionFactor = 1.0f, float samplingStrenght = 10.0f)
    private static native long createRetina_1(double inputSize_width, double inputSize_height, boolean colorMode, int colorSamplingMethod, boolean useRetinaLogSampling, float reductionFactor, float samplingStrenght);
    private static native long createRetina_2(double inputSize_width, double inputSize_height, boolean colorMode);
